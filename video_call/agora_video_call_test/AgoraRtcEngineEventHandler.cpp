...
CAgoraRtcEngineEventHandler::CAgoraRtcEngineEventHandler(void)
{
}
...
void CAgoraRtcEngineEventHandler::SetMsgReceiver(HWND hWnd)
{
	m_hMainWnd = hWnd;
}
...
*/
void CAgoraRtcEngineEventHandler::onJoinChannelSuccess(const char* channel, uid_t uid, int elapsed)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onRejoinChannelSuccess(const char* channel, uid_t uid, int elapsed)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onWarning(int warn, const char* msg)
{
	CString str;
...
*/
void CAgoraRtcEngineEventHandler::onError(int err, const char* msg)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onAudioQuality(uid_t uid, int quality, unsigned short delay, unsigned short lost)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onAudioVolumeIndication(const AudioVolumeInfo* speakers, unsigned int speakerNumber, int totalVolume)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onLeaveChannel(const RtcStats& stat)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onRtcStats(const RtcStats& stat)
{
	CString str;
...
*/
void CAgoraRtcEngineEventHandler::onMediaEngineEvent(int evt)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onAudioDeviceStateChanged(const char* deviceId, int deviceType, int deviceState)
{
	if (m_hMainWnd == NULL)
		return;
...
@param deviceState	Device state: MEDIA_DEVICE_STATE_TYPE.
*/
void CAgoraRtcEngineEventHandler::onVideoDeviceStateChanged(const char* deviceId, int deviceType, int deviceState)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onLastmileQuality(int quality)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onFirstLocalVideoFrame(int width, int height, int elapsed)
{
...
*/
void CAgoraRtcEngineEventHandler::onFirstRemoteVideoDecoded(uid_t uid, int width, int height, int elapsed)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onFirstRemoteVideoFrame(uid_t uid, int width, int height, int elapsed)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onUserJoined(uid_t uid, int elapsed)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onUserOffline(uid_t uid, USER_OFFLINE_REASON_TYPE reason)
{
	if (m_hMainWnd == NULL)
		return;
...
@param muted	Whether the remote user's audio stream is muted/unmuted:
    ...
    false: Unmuted.
*/
void CAgoraRtcEngineEventHandler::onUserMuteAudio(uid_t uid, bool muted)
{
	if (m_hMainWnd == NULL)
		return;
...
@param muted	Whether the remote user's video stream playback is paused/resumed:
        ...
        false: Resumed.
*/
void CAgoraRtcEngineEventHandler::onUserMuteVideo(uid_t uid, bool muted)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onStreamMessage(uid_t uid, int streamId, const char* data, size_t length)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onApiCallExecuted(const char* api, int error)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onLocalVideoStats(const LocalVideoStats& stats)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onRemoteVideoStats(const RemoteVideoStats& stats)
{
	if (m_hMainWnd == NULL)
		return;
...
*/
void CAgoraRtcEngineEventHandler::onCameraReady()
{
	if(m_hMainWnd != NULL)
...
*/
void CAgoraRtcEngineEventHandler::onVideoStopped()
{
	if (m_hMainWnd != NULL)
...
*/
void CAgoraRtcEngineEventHandler::onConnectionLost()
{
	if(m_hMainWnd != NULL)
...
*/
void CAgoraRtcEngineEventHandler::onConnectionInterrupted()
{
	CString str;
...
*/
void CAgoraRtcEngineEventHandler::onUserEnableVideo(uid_t uid, bool enabled)
{
//	if (m_hMainWnd != NULL)
//		::PostMessage(m_hMainWnd, WM_MSGID(EID_CONNECTION_LOST), 0, 0);
...
REMOTE_VIDEO_STATE_DECODING (2) and REMOTE_VIDEO_STATE_REASON_REMOTE_UNMUTED (6).
*/
void CAgoraRtcEngineEventHandler::onStartRecordingService(int error)
{
	if (m_hMainWnd != NULL)
...
Deprecated
*/
void CAgoraRtcEngineEventHandler::onStopRecordingService(int error)
{
	if (m_hMainWnd != NULL)
...
Deprecated
*/
void CAgoraRtcEngineEventHandler::onRefreshRecordingServiceStatus(int status)
{
	if (m_hMainWnd == NULL)
		return;
